...
const Home = () => {
  ...
  return (<>
    ...
    <section id="heroSection">
      <div className="container col-xxl-12 py-md-5 py-0">
        <div className="row mx-0 flex-lg-row-reverse align-items-start justify-content-between g-5 pb-5">
                ...
                >
                  {({ isSubmitting }) => (
                    <Form className="d-flex justify-content-center flex-column align-items-center w-100">
                      ...
                      <Field
                        as="textarea"
                        className="formBoxes noOutlineBorder txtArea"
                        placeholder={formTriggerSource === 'Start Now'
                          ? 'What are your goals or desired behaviors? e.g., reach rural customers, punctual employees, quit smoking'
            ...
            {thanks && (
              <div className="innerRBB d-flex align-items-center justify-content-evenly flex-column">
                ...
                <div className="text-white  px-5">
                  <p className="display-6 fs-1 text-center">Thank you!
                ...
                <div className="d-flex align-items-center justify-content-evenly">
                  ...
                  <a href="https://www.instagram.com/behavrior" target="_blank" rel="noreferrer"> <InstagramIcon className="socialMediaIcons" /></a>
                </div>
              </div>
            )}
          ...
          <div className="col-lg-6 d-flex flex-column justify-content-between leftBox px-0">
            <div>
              ...
              <div className="d-grid gap-2 d-md-flex justify-content-md-start">
                <a href="#howWeShapeSection" className="cstmAnchor text-decoration-none fs-4 text-dark fw-medium">Learn More...</a>
              </div>
            </div>
    ...
    <section id="sliderSection">
      <div className="container col-xxl-12 px-4 py-md-5 py-0">
        <div className="row mx-0 align-items-center justify-content-between g-5 py-5 px-1">
          <div className="col-lg-12 d-flex flex-column justify-content-between px-0">
            <div className="d-flex align-items-center flex-column">
              ...
              <p className="lead fw-medium cstmPara text-center subHeading">Delve into the realm of impactful behaviors as we reveal strategies
          ...
          <div className="col-12 px-0">
            ...
            <div className="row mx-0 align-items-center justify-content-between g-5 py-5  mb-4" >
              ...
              <div className="col-lg-6 d-flex flex-column justify-content-between px-0">
                <div className="d-flex flex-column gap-4">
                  <h1 className="display-6 fw-medium text-body-emphasis lh-1 mb-0">Spread Your <span className="brownTextColor">Story</span>, <br />
            ...
            <div className=" row mx-0 flex-row-reverse  align-items-center justify-content-between g-5 py-5  mb-4">
              ...
              <div className="col-lg-6 d-flex flex-column justify-content-between px-0">
                <div className="d-flex flex-column gap-4">
                  <h1 className="display-6 fw-medium text-body-emphasis lh-1 mb-0">Transform Your <span className="seaTextColor">Workplace</span>, <br />
            ...
            <div className="row mx-0 align-items-center justify-content-between g-5 py-5  mb-4" >
              ...
              <div className="col-lg-6 d-flex flex-column justify-content-between px-0">
                <div className="d-flex flex-column gap-4">
                  <h1 className="display-6 fw-medium text-body-emphasis lh-1 mb-0"><span className="seaGreenTextColor">Store</span> That Works, <br />
            ...
            <div className=" row mx-0 flex-row-reverse  align-items-center justify-content-between g-5 py-5  mb-4">
              ...
              <div className="col-lg-6 d-flex flex-column justify-content-between px-0">
                <div className="d-flex flex-column gap-4">
                  <h1 className="display-6 fw-medium text-body-emphasis lh-1 mb-0">Uncover The
                    <span className="seablueTextColor"> Core</span>, <br /> Ignite the
            ...
            <div className="row mx-0 align-items-center justify-content-between g-5 py-5  mb-4" >
              ...
              <div className="col-lg-6 d-flex flex-column justify-content-between px-0">
                <div className="d-flex flex-column gap-4">
                  <h1 className="display-6 fw-medium text-body-emphasis lh-1 mb-0"><span className="yellowBrownTextColor"> Best Version</span> Of Me, <br /> Today, <span className="yellowBrownTextColor"> Every day</span></h1>
            ...
            <div className=" row mx-0 flex-row-reverse  align-items-center justify-content-between g-5 py-5  mb-4">
              ...
              <div className="col-lg-6 d-flex flex-column justify-content-between px-0">
                <div className="d-flex flex-column gap-4">
                  <h1 className="display-6 fw-medium text-body-emphasis lh-1 mb-0"><span className="yellowGreenTextColor"> Individual</span> Shifts, <br />
        ...
        <div className="row mx-0 align-items-center justify-content-between g-5 py-5 px-1">
          <div className="col-lg-12 d-flex flex-column justify-content-between px-0">
            <div className="d-flex flex-column align-items-center">
              ...
              <p className="lead fw-normal cstmPara text-center subHeading">We ensure achieving your intended behaviors and goals via our customized approach.</p>
            </div>
          </div>
            ...
            <div className="row mx-0 align-items-center justify-content-between g-5 py-5 width95 mb-0 mb-md-4" >
              ...
              <div className="col-lg-12 d-flex justify-content-center px-0">
                <div className="col-md-10">
                  <p className="lead fw-normal text-center">Shaping behaviors is a nuanced undertaking, demanding the integration of
          ...
          <div className="col-12 px-0">
            <div className="row mx-0 align-items-center justify-content-between g-5  width95 mb-4" >
              ...
              {!isMobile && <div className="col-lg-12 d-flex flex-column justify-content-center px-0" style={{ marginTop: "-80px" }}>
        ...
        <div className="row mx-0 align-items-center justify-content-between g-5 py-5 px-1">
          <div className="col-lg-12 d-flex flex-column justify-content-between px-0">
            <div className="d-flex flex-column align-items-center">
              ...
              <p className="lead fw-medium cstmPara text-center subHeading">We are consistently engaged in developing behavior-building products that anyone can use.</p>
            </div>
          </div>
          ...
          <div className="col-12 px-0">
            ...
            <div className="row mx-0 align-items-center justify-content-between g-5 py-5 width95 mb-0 mb-md-4" >
              ...
              <div className="col-12 col-sm-8 col-lg-3 p-3 d-flex align-items-center justify-content-center mt-0 mt-md-5">
                <img src="assets/img/nudgeware_logo.png" alt="tools" className="toolsImage" />
              </div>
          ...
          <div className="col-12 px-0 m-0">
            ...
            <div className="row mx-0 align-items-center justify-content-between g-5 py-5 width95 mb-0 mb-md-4">
              <div className="col-12 col-sm-8 col-lg-3 order-sm-2 p-3 d-flex align-items-center justify-content-center mt-0 mt-md-5">
                <img src="assets/img/punchtual_logo.png" alt="" className="toolsImage" />
              </div>

              <div className="col-lg-9 d-flex justify-content-end px-0 order-sm-1">
          ...
          <div className="col-12 px-0 m-0">
            ...
            <div className="row mx-0 align-items-center justify-content-between g-5 py-5 width95 mb-0 mb-md-4" >
              ...
              <div className="col-12 col-sm-8 col-lg-3 p-3 d-flex align-items-center justify-content-center mt-0 mt-md-5">
                <img src="assets/img/followup_logo.png" alt="" className="toolsImage" />
              </div>
    ...
    <section id="aboutSection">
      <div className="container col-xxl-12 px-4 py-md-5 py-0 minHeight d-flex align-items-center justify-content-between">
        <div className="row mx-0 align-items-center justify-content-between g-5 py-5">
          ...
          <div className="col-12 col-sm-8 col-lg-6 rounded-4 d-flex align-items-center justify-content-center p-3 mt-0">
            <div className=" d-flex align-items-center justify-content-md-evenly justify-content-start  flex-column">
              <p className="heroText text-justify aboutUsFS fw-medium mb-0"> We are a team deeply immersed in
